                                                ...
                                                <div class="row">
                                                    <div style="width: 20px; padding-left:10px">
                                                        <input style="border-radius: 5px"
                                                            class="@error('paystack') is-invalid @enderror" type="radio"
                                                            value="{{ old('paystack') }}" id="paystack" name="paystack">
                                                    </div>
                                        ...
                                        <div class="card-header" id="headingTwo">
                                            <label data-toggle="collapse" data-target="#collapseTwo"
                                                ...
                                                <div class="row">
                                                    <div style="width: 20px; padding-left:10px">
                                                        <input style="border-radius: 5px" 
                                                            class="@error('stripe') is-invalid @enderror" type="radio"
                                                            value="{{ old('stripe') }}" id="paystack" name="stripe">
                                                    </div>
                                                    <div class="col-md-6 col-lg-6 col-12">
                    ...
                    @if (count($carts) > 0)
                        <div class="col-12 col-md-5 col-lg-3">
                            <div class="ps-shopping__box mt-5" style="background: #fff">
                                ...
                                <div class="ps-shopping__text">You will be able to add a voucher when selecting your
                                    payment method.</div>
                                <input type="hidden" id="amount" name="amount"
                                    value="{{ \Cart::priceTotalFloat() }}">
                                <div class="ps-shopping__checkout">
                                    <button class="ps-btn ps-btn--success" style="border-radius:5px"
